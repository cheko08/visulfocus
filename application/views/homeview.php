            ...
            <div class="item active">
             ...
             <div class="container">
              <div class="carousel-caption">
                <h1>Marketing Empresarial</h1>
                <p>Diseñamos e  Implementamos diversas estrategias innovadoras que contribuyan a
                 involucrar a los consumidores con un determinado producto o servicio, con el
                 objetivo de optimizar las ventas de nuestros clientes</p>
                 <p><a class="btn btn-lg btn-primary" href="<?php echo base_url('servicios/marketing');?>" role="button">Ver Mas</a></p>
               </div>
             </div><!-- end caption -->
           </div>
           <div class="item">
             ...
             <div class="container">
              <div class="carousel-caption">
                ...
                <p>Planeación, coordinación y supervisión de eventos empresariales</p>
                <p>Diseño-Estructura-Contenido-Conclusión del evento.</p>
                <p><a class="btn btn-lg btn-primary" href="<?php echo base_url('servicios/eventos');?>" role="button">Ver Mas</a></p>
              </div>
            </div><!-- end caption -->
          </div>
          <div class="item">
           ...
           <div class="container">
            <div class="carousel-caption">
              <h1>Modelos y Edecanes</h1>
              <p>Ofrecemos una Excelente imagen, actitud y profesionalismo para transmitir el
               prestigio y calidad de la marca de nuestros clientes
               a través de nuestro personal Capacitado.</p>
               <p><a class="btn btn-lg btn-primary" href="<?php echo base_url('servicios/modelos');?>" role="button">Ver Mas</a></p>
             </div>
           </div><!-- end caption -->
         </div>
       </div>
